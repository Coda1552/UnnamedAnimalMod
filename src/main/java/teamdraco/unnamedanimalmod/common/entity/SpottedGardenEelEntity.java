...
public class SpottedGardenEelEntity extends AbstractFish {
    ...
    protected void registerGoals() {
        ...
        if (!this.isHidden()) {
            this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, Player.class, 10, 2.0D, 2.5D));
            this.goalSelector.addGoal(3, new SpottedGardenEelEntity.SwimGoal(this));
        }
    }
    ...
    static class MoveHelperController extends MoveControl {
        ...
        public void tick() {
            ...
            if (this.operation == Operation.MOVE_TO && !this.fish.getNavigation().isDone()) {
                ...
                if (d0 != 0.0D || d2 != 0.0D) {
                    float f1 = (float)(Math.atan2(d2, d0) * (double)(180F / (float)Math.PI)) - 90.0F;
