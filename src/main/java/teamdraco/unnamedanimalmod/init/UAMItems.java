...
public class UAMItems {
    ...
    public static final RegistryObject<Item> FLASHLIGHT_FISH_BUCKET = ITEMS.register("flashlight_fish_bucket", () -> new MobBucketItem(UAMEntities.FLASHLIGHT_FISH, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> PLATYPUS_BUCKET = ITEMS.register("platypus_bucket", () -> new UAMCatchableItem(UAMEntities.PLATYPUS::get, Items.BUCKET, false, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> ELEPHANTNOSE_FISH_BUCKET = ITEMS.register("elephantnose_fish_bucket", () -> new MobBucketItem(UAMEntities.ELEPHANTNOSE_FISH, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> BLACK_DIAMOND_STINGRAY_BUCKET = ITEMS.register("black_diamond_stingray_bucket", () -> new MobBucketItem(UAMEntities.BLACK_DIAMOND_STINGRAY, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> BANANA_SLUG_POT = ITEMS.register("banana_slug_pot", () -> new UAMCatchableItem(UAMEntities.BANANA_SLUG::get, Items.FLOWER_POT, false, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> TOMATO_FROG_BOWL = ITEMS.register("tomato_frog_bowl", () -> new UAMCatchableItem(UAMEntities.TOMATO_FROG::get, Items.BOWL, false, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> PACMAN_FROG_BOWL = ITEMS.register("pacman_frog_bowl", () -> new UAMCatchableItem(UAMEntities.PACMAN_FROG::get, Items.BOWL, false, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> ROCKET_KILLIFISH_BUCKET = ITEMS.register("rocket_killifish_bucket", () -> new MobBucketItem(UAMEntities.ROCKET_KILLIFISH, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> BABY_HUMPHEAD_PARROTFISH_BUCKET = ITEMS.register("baby_humphead_parrotfish_bucket", () -> new MobBucketItem(UAMEntities.HUMPHEAD_PARROTFISH, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> FIDDLER_CRAB_BUCKET = ITEMS.register("fiddler_crab_bucket", () -> new UAMCatchableItem(UAMEntities.FIDDLER_CRAB::get, Fluids.WATER, Items.BUCKET, false, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> LEAFY_SEADRAGON_BUCKET = ITEMS.register("leafy_seadragon_bucket", () -> new MobBucketItem(UAMEntities.LEAFY_SEADRAGON, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> SPOTTED_GARDEN_EEL_BUCKET = ITEMS.register("spotted_garden_eel_bucket", () -> new MobBucketItem(UAMEntities.SPOTTED_GARDEN_EEL, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, defaultProperties().stacksTo(1)));
    public static final RegistryObject<Item> MUDSKIPPER_BUCKET = ITEMS.register("mudskipper_bucket", () -> new UAMCatchableItem(UAMEntities.MUDSKIPPER::get, Fluids.WATER, Items.BUCKET, false, defaultProperties().stacksTo(1)));
    ...
    // Spawn Eggs
    public static final RegistryObject<Item> BLACK_DIAMOND_STINGRAY_SPAWN_EGG = ITEMS.register("black_diamond_stingray_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.BLACK_DIAMOND_STINGRAY, 0x35374e, 0xf2f3fe, defaultProperties()));
    public static final RegistryObject<Item> TOMATO_FROG_SPAWN_EGG = ITEMS.register("tomato_frog_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.TOMATO_FROG, 0x961900, 0xf1800a, defaultProperties()));
    public static final RegistryObject<Item> SOUTHERN_RIGHT_WHALE_SPAWN_EGG = ITEMS.register("southern_right_whale_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.SOUTHERN_RIGHT_WHALE, 0x263334, 0xcdcabc, defaultProperties()));
    public static final RegistryObject<Item> GREATER_PRAIRIE_CHICKEN_SPAWN_EGG = ITEMS.register("greater_prairie_chicken_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.GREATER_PRAIRIE_CHICKEN, 0x4e4340, 0xeda825, defaultProperties()));
    public static final RegistryObject<Item> FLASHLIGHT_FISH_SPAWN_EGG = ITEMS.register("flashlight_fish_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.FLASHLIGHT_FISH, 0x1a0d11, 0xf7ffff, defaultProperties()));
    public static final RegistryObject<Item> HUMPHEAD_PARROTFISH_SPAWN_EGG = ITEMS.register("humphead_parrotfish_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.HUMPHEAD_PARROTFISH, 0x3c667f, 0x6cb8a2, defaultProperties()));
    public static final RegistryObject<Item> MUSK_OX_SPAWN_EGG = ITEMS.register("musk_ox_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.MUSK_OX, 0x3e2c25, 0xc9b8a3, defaultProperties()));
    public static final RegistryObject<Item> BANANA_SLUG_SPAWN_EGG = ITEMS.register("banana_slug_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.BANANA_SLUG, 0xe2ba4c, 0xa78330, defaultProperties()));
    public static final RegistryObject<Item> MARINE_IGUANA_SPAWN_EGG = ITEMS.register("marine_iguana_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.MARINE_IGUANA, 0x27272d, 0x78f7d4, defaultProperties()));
    public static final RegistryObject<Item> PLATYPUS_SPAWN_EGG = ITEMS.register("platypus_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.PLATYPUS, 0x71492a, 0x544b38, defaultProperties()));
    public static final RegistryObject<Item> PACMAN_FROG_SPAWN_EGG = ITEMS.register("pacman_frog_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.PACMAN_FROG, 0x9a9c26, 0x3d1a0c, defaultProperties()));
    public static final RegistryObject<Item> ELEPHANTNOSE_FISH_SPAWN_EGG = ITEMS.register("elephantnose_fish_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.ELEPHANTNOSE_FISH, 0x4c3b36, 0xc9c1b9, defaultProperties()));
    public static final RegistryObject<Item> CAPYBARA_SPAWN_EGG = ITEMS.register("capybara_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.CAPYBARA, 0x9e5d39, 0x412f24, defaultProperties()));
    public static final RegistryObject<Item> ROCKET_KILLIFISH_SPAWN_EGG = ITEMS.register("rocket_killifish_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.ROCKET_KILLIFISH, 0x172639, 0x49fff2, defaultProperties()));
    public static final RegistryObject<Item> MANGROVE_SNAKE_SPAWN_EGG = ITEMS.register("mangrove_snake_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.MANGROVE_SNAKE, 0x202023, 0xda9409, defaultProperties()));
    // public static final RegistryObject<Item> BLUBBER_JELLY_SPAWN_EGG = REGISTRY.register("blubber_jelly_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.BLUBBER_JELLY, 0x50ccb7, 0x50ccb7, defaultProperties()));
    public static final RegistryObject<Item> FIDDLER_CRAB_SPAWN_EGG = ITEMS.register("fiddler_crab_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.FIDDLER_CRAB, 0xb7510e, 0xf7bb4b, defaultProperties()));
    public static final RegistryObject<Item> LEAFY_SEADRAGON_SPAWN_EGG = ITEMS.register("leafy_seadragon_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.LEAFY_SEADRAGON,  0xffd95a, 0xd2d44a, defaultProperties()));
    public static final RegistryObject<Item> SPOTTED_GARDEN_EEL_SPAWN_EGG = ITEMS.register("spotted_garden_eel_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.SPOTTED_GARDEN_EEL,  0xa3a786, 0x35342f, defaultProperties()));
    public static final RegistryObject<Item> MUDSKIPPER_SPAWN_EGG = ITEMS.register("mudskipper_spawn_egg", () -> new ForgeSpawnEggItem(UAMEntities.MUDSKIPPER,  0x4e4031, 0x6cd3a9, defaultProperties()));
