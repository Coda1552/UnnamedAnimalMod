...
public class UAMConfig {
    ...
    public static class Common {
        ...
        public final ForgeConfigSpec.IntValue spottedGardenEelSpawnWeight;
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            humpheadParrotfishSpawnWeight = builder.comment("Spawn weight of Humphead Parrotfish").defineInRange("humphead_parrotfish_spawn_weight", 3, 1, 1000);
            ...
            pacmanFrogSpawnWeight = builder.comment("Spawn weight of Pacman Frogs").defineInRange("pacman_spawn_weight", 3, 1, 1000);
            ...
            spottedGardenEelSpawnWeight = builder.comment("Spawn weight of Spotted Garden Eels").defineInRange("spotted_garden_eel_spawn_weight", 3, 1, 1000);
            builder.pop();
        }
        ...
        public static void reload() {
            ...
            UAMConfig.spottedGardenEelSpawnWeight = INSTANCE.spottedGardenEelSpawnWeight.get();
        }
    }
}
